...
public class QuizManagerStatic : MonoBehaviour
{
    ...
    {
        //FOR THE QUESTIONS LOADED DEPENDING ON WHAT LEVELS 1, 2 or 3
        if (level == 1) fileName = "questions1.txt";
        else if (level == 2) fileName = "questions2.txt";
        else if (level == 3) fileName = "questions3.txt";
